...
cesiumMap.initCesium = function () {
  ...
  add3dTiles(viewer, 'tiles/3dtiles/Area_58_v6/tileset.json', 0.2, "#ffffff", 0.3, false);
  ...
  add3dTiles(viewer, 'tiles/3dtiles/TCE_v2_Barrier/tileset.json', 0.15, "", 1, false);
  add3dTiles(viewer, 'tiles/3dtiles/TCE_v2_NoBarrier_v2/tileset.json', 0.15, "", 1, false);
  
  add3dTiles(viewer, 'tiles/3dtiles/CEDD_TCNTE/tileset.json', 0.2, "#ffffff", 0.3, true);
